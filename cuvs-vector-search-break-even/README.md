...
Companion to the Ramwise field note on exact and approximate GPU vector search.
...
The committed notebook reads a sanitized table of confirmed medians. It does
not need a GPU merely to display or regenerate the analysis. The separate
